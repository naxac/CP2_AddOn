...
use constant section_to_class => {
	...
	zone_generator1				=> 'se_zone_anom',
	zone_tik_tak				=> 'se_zone_anom',
	...
	zone_campfire_mp_nolight		=> 'se_zone_anom',
	zone_campfire_grill				=> 'se_zone_anom',
	zone_flame						=> 'se_zone_anom',
	zone_zhar						=> 'se_zone_anom',
	zone_emi						=> 'se_zone_anom',
	zone_flame_small				=> 'se_zone_anom',
	zone_flame_small_stove			=> 'se_zone_anom',
	...
	zone_ogon			        	=> 'se_zone_anom',
	zone_ogon_strong				=> 'se_zone_anom',
        

	zone_mine_field					=> 'se_zone_anom',
	zone_mine_death					=> 'se_zone_anom',
	zone_death						=> 'se_zone_anom',
	...
	wpn_val						=> 'cse_alife_item_weapon_magazined_w_gl',
	...
	zone_zvon					=> 'se_zone_anom',
	zone_apocalypse				=> 'cse_alife_anomalous_zone',
...
if (defined $spawn_file) {
	...
	$out = 'new.spawn' unless defined $out;
